  ...
  return (
    <>
      ...
      <aside className={`
        ...
        w-64 bg-white dark:bg-slate-900 border-r border-slate-200/80 dark:border-slate-800/80 
        min-h-[calc(100vh-4rem)] p-4 flex flex-col justify-between transition-transform duration-300 ease-in-out shrink-0
